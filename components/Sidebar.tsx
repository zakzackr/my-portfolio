        ...
        <div className="w-full">
            ...
            <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <a href="https://github.com/zakzackr" className="text-blue-600 hover:underline">GitHub</a>
                </div>
                ...
                <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <a href="https://qiita.com/shibainuu" className="text-blue-600 hover:underline">Qiita</a>
                </div>
                ...
                <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <a href="https://zenn.dev/shibainuu" className="text-blue-600 hover:underline">Zenn</a>
                </div>
            </div>
